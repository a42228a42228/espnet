...
# ln -s $(pwd)/downloads/d3b0a3afbf3c5e54e676885ec949237b/exp/tts_train_vits_raw_phn_jaconv_pyopenjtalk_prosody/tokens.txt ${TOKEN_LIST_DIR}/tokens.txt
