...
data_folder="/home/hsieh/espnet/egs2/nhk_radio/tts1/data/phrase_emphasis"
output_folder="/home/hsieh/espnet/egs2/nhk_radio/tts1/data/phrase_emphasis/cross_validation"
k=9  # 折數
random_seed=42
...
def split_dataset_by_article(data_folder, output_folder, k=5, random_seed=42):
    ...
    def extract_article_name(utt_id):
        ...
        return "_".join(utt_id.split("_")[:-2])
