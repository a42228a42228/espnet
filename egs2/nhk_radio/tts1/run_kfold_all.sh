...
run_fold() {
    ...
    ./tts.sh \
        ...
        --train_args "--init_param downloads/7e515fa2fd318b964d69b992a1bee634/exp/tts_train_full_band_vits_raw_phn_jaconv_pyopenjtalk_prosody/train.total_count.ave_10best.pth:::tts.generator.text_encoder.emb" \
        --tag "${tag_prefix}_fold_${fold}_finetune_vits_raw_phn_jaconv_${g2p}" \
        "${additional_opts[@]}"
